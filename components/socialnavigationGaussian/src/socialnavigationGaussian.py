...
# \mainpage RoboComp::socialnavigationGaussian
#
...
#
# Just: "${PATH_TO_BINARY}/socialnavigationGaussian --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
	...
	adapter = ic.createObjectAdapter('SocialNavigationGaussian')
	adapter.add(SocialNavigationGaussianI(worker), ic.stringToIdentity('socialnavigationgaussian'))
	adapter.activate()
